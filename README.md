...
[![Build Status](https://github.com/ansible/#awx-resource-go-operator/workflows/CI/badge.svg?event=push)](https://github.com/ansible/#awx-resource-go-operator/actions)
...
This is a golang re-write of the [awx-resource-operator](https://github.com/ansible/awx-resource-operator), which was originally written with the ansible-operator-sdk.
...
* [AWX Resource Go Operator](#awx-resource-go-operator)
   * [Overview](#overview)
...
There are currently two Custom Resources provided by the awx-resource-go-operator:
...
1. Clone the #awx-resource-go-operator

```
git clone git@github.com:ansible/#awx-resource-go-operator.git
```
...
```
NAMESPACE=awx IMG=quay.io/ansible/#awx-resource-go-operator:latest make deploy
```
...
Now that the #awx-resource-go-operator is installed in your cluster, you can try creating a k8s resource to manage your AWX instance.
...
We welcome your feedback and ideas. The AWX Resource Go Operator uses the same mailing list and IRC channel as AWX itself. Here's how to reach us with feedback and questions:
